...
export function NavigationVisbilityObserver({
	children,
	className,
	...rest
}: {
	...
	return (
		<ul
			className={clsx(styles["NavBar-primary-nav-list"], className)}
			ref={navRef}
			{...rest}
		>
				...
				return React.cloneElement(child, {
					className: clsx(
						...
						isMedium &&
							...
							styles["NavBar-primary-nav-list-item--visible"],
						isMedium &&
							!visibilityMap[child.props["data-navitemid"]] &&
							styles["NavBar-primary-nav-list-item--invisible"]
					),
				});
			})}
...
function AnchoredOverlay({
	...
	return (
		<li
			className={clsx(
				styles["NavBar-primary-nav-list-item--overflow"],
				className
			)}
			ref={ref}
		>
			<button
				...
				aria-haspopup="true"
				onClick={handleClick}
				className={clsx(styles["NavBar-link"], styles["NavBar-more-link"])}
			>
				More
				<ChevronDownIcon />
			</button>
			...
			<div
				...
				className={clsx(styles["NavBar-overflow-menu"])}
			>
				<ul className={clsx(styles["NavBar-overflow-menu-list"])}>
					{React.Children.map(children, (child) => {
								...
								return (
									<React.Fragment>
										{React.cloneElement(child as React.ReactElement, {
											onClick: handleClose,
											className: clsx(
												styles["NavBar-overflow-menu-item"],
												child.props.className
											),
										})}
									</React.Fragment>
